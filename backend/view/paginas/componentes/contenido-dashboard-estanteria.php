...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Estanterias</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./dashboard-inicio">Inicio</a></li>
              <li class="breadcrumb-item active">Estanterias</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="input-group rounded">
                    <button type="button" class="btn btn-success"><i class="fa fa-clipboard"> Registrar nueva Estanteria</i></button>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>ID Estanterias</th>
                      <th>Tipo de Estanterias</th>
                      <th>Acciones</th>
                    </tr>
                  </thead>
                  <tbody>
