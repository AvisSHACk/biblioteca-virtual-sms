                    ...
                    <div class="card">
                        <div class="card-header">
                          <div class="input-group rounded">
                            <button type="button" class="btn btn-success"><i class="fa fa-list"> Registrar nuevo Prestamo</i></button>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>28/08/2019</td>
                                            <td>200</td>
                                            <td><span class="badge bg-warning">Premiun</span></td>
                                            <td>015</td>
                                            <td>001</td>
